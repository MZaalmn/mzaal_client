    ...
    <footer style={styles.footer}>
      <div style={styles.container}>
        ...
        <div style={styles.section}>
          ...
          <p>
            <strong>Хаяг:</strong> Чингисийн Өргөн Чөлөө-6, Стадион Оргил-1, Хан-Уул Дүүрэг
            15-р хороо, Улаанбаатар, 17010, Монгол Улс
          </p>
          <p>
            <strong>Email:</strong>{" "}
            <a
        ...
        <div style={styles.section}>
          ...
          <ul style={styles.list}>
            {[
              ...
              { label: "Бүх заруудыг харах →", href: "#", highlight: true },
            ].map((item, index) => (
              <li key={index} style={styles.listItem}>
                <a
                  ...
                  style={{
                    ...styles.link,
                    color: item.highlight ? "#ffcc00" : "white",
                    fontWeight: item.highlight ? "bold" : "normal",
                  }}
                  onMouseEnter={(e) => (e.target.style.color = "#ff4c00")}
                  onMouseLeave={(e) =>
                    (e.target.style.color = item.highlight ? "#ffcc00" : "white")
                  }
                >
                  {item.label}
                </a>
        ...
        <div style={{ ...styles.section, textAlign: "center" }}>
          ...
          <div style={styles.socialIcons}>
            {["Twitter", "Facebook", "Reddit", "Instagram"].map((platform, index) => (
              <a
                key={index}
                href="#"
